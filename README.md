...
- **Android 10 이상 ARM64:** [Android APK 1.6.3 다운로드](https://github.com/DustinJung/forYoujinApp-releases/releases/download/v1.6.3/DustinYTDownloader-v1.6.3-Android-arm64.apk)
...
- `DustinYTDownloader-v1.6.3-Android-arm64.apk`: Android 10 이상 ARM64 직접 배포판
